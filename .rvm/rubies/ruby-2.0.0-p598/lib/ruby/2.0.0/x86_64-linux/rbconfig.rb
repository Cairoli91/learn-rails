...
module RbConfig
  ...
  CONFIG["MINOR"] = "0"
  CONFIG["TEENY"] = "0"
  CONFIG["PATCHLEVEL"] = "598"
  CONFIG["INSTALL"] = "/usr/bin/install"
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/rvm/rubies/ruby-2.0.0-p598")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/local/rvm/rubies/ruby-2.0.0-p598' '--enable-load-relative' '--sysconfdir=/etc' '--disable-install-doc' '--enable-shared'"
